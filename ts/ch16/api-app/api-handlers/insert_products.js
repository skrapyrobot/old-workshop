...
async function loadProducts() {
    ...
    for (let product of product_data_1.items) {
        let putItemInput = createPutItemInput(
            ...
            product.specs
                ? parseFloat(
                      (_a = product.specs) === null || _a === void 0
                          ? void 0
                          : _a.actuationForce
                  )
                : 0,
            product.specs
                ? parseFloat(
                      (_b = product.specs) === null || _b === void 0
                          ? void 0
                          : _b.actuationPoint
                  )
                : 0,
            product.specs
                ? parseFloat(
                      (_c = product.specs) === null || _c === void 0
                          ? void 0
                          : _c.bottomOut
                  )
                : 0,
            product.specs
                ? parseFloat(
                      (_d = product.specs) === null || _d === void 0
                          ? void 0
                          : _d.bottomOutTravel
                  )
                : 0,
            product.specs
                ? parseFloat(
                      (_e = product.specs) === null || _e === void 0
                          ? void 0
                          : _e.price
                  ) * 100
                : 0
        );
        let result = await executePutItem(
